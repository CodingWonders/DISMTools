...
We continue the development of the next version in the Preview branch. To go to it, select "dt_pre_0.8.1" from the branch list. Commits are done every day, and new builds are released every 2 weeks.

**NOTE:** this branch contains release candidate builds of DISMTools 0.8.1, and will be deleted once this version gets published as a stable release
