...
However, if you want to download the latest release AS SOON AS the project is built with new changes, you can download the [nightly installer](https://github.com/CodingWonders/DISMTools/raw/dt_pre_2385_escrow/Installer/Output/dt_setup.exe).

**NOTE:** this branch contains release candidate (formerly known as "escrow") builds of DISMTools 0.3.1, and it will be deleted once this version gets published as a stable release
