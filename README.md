...
However, if you want to download the latest release AS SOON AS the project is built with new changes, you can download the [nightly installer](https://github.com/CodingWonders/DISMTools/raw/dt_pre_23105_relcndid/Installer/Output/dt_setup.exe).

**NOTE:** this branch contains release candidate builds of DISMTools 0.3.3, and will be deleted once this version gets published as a stable release
