...
Public Class DynaLog
    ...
    Public Shared Sub LogMessage(message As String, Optional GetParentCaller As Boolean = True)
        ...
        Try
            ...
            End If
            Dim MessagePrefix As String = "[" & Date.UtcNow.ToString("MM/dd/yyyy HH:mm:ss", CultureInfo.InvariantCulture) & "] " & "[" & New StackFrame(1).GetMethod().Name & If(GetParentCaller, " (" & New StackFrame(2).GetMethod().Name & ")", "") & "] "
