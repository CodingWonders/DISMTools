...
Public Class DynaLog
    ...
    Public Shared Sub BeginLogging()
        LogMessage("DynaLog Logger has begun logging program operations...")
        LogMessage("--- Time Stamps are shown in UTC Time!!! ---")
    End Sub

    Public Shared Sub EndLogging()
        LogMessage("DynaLog Logger has stopped logging program operations...")
    End Sub
    ...
    Public Shared Sub LogMessage(message As String)
        ...
        Try
            ...
            End If
            Dim MessageLine As String = "[" & Date.UtcNow.ToString("MM/dd/yyyy HH:mm:ss") & "] " & message
