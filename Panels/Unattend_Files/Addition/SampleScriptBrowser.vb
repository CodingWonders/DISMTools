    ...
    Private Sub ExportScriptCodeBtn_Click(sender As Object, e As EventArgs) Handles ExportScriptCodeBtn.Click
        ...
        If targetSS IsNot Nothing Then
            Select Case targetSS.Language.ToLower()
                Case "batch" : ScriptCodeExporterSFD.Filter = LocalizationService.ForSection("Panels.Unattend.Scripts")("BatchScripts.Filter")
                Case "powershell" : ScriptCodeExporterSFD.Filter = LocalizationService.ForSection("Panels.Unattend.Scripts")("Power.Shell.Filter")
                Case Else : ScriptCodeExporterSFD.Filter = LocalizationService.ForSection("Panels.Unattend.Scripts")("AllFiles.Filter")
            End Select
        Else
