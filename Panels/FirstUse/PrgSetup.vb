    ...
    Private Sub PrgSetup_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case My.Computer.Info.InstalledUICulture.ThreeLetterWindowsLanguageName
            ...
            Case "ITA"
                ...
                Label5.Text = "Rendilo tuo. Personalizza questo programma a piacimento e selrziona 'Avanti'. Queste impostazioni possono essere configurate in qualsiasi momento in 'Opzioni' -> 'Personalizzazione'"
                ...
                Label13.Text = "Specifica le impostazioni del registro e seleziona 'Avanti'. A seconda del livello specificato, verranno registrate più o meno informazioni. Questa impostazione può essere configurata in qualsiasi momento in 'Opzioni' -> 'Registri'"
                Label14.Text = "Cosa registrare quando si esegue un'operazione?"
                ' Same here
                Label16.Text = "Il file registro deve visualizzare gli errori, le avvertenze e i messaggi informativi dopo l'esecuzione di un'operazione sull'immagine."
                Label20.Text = "C'è qualcos'altro che vuoi configurare?"
                ...
                Label25.Text = "Ora che hai configurato il tutto, ti consigliamo di fare le seguenti cose:"
                Label26.Text = "Rimanere aggiornati per ricevere nuove funzionalità e un'esperienza migliorata"
                ...
                Label29.Text = "Questo font potrebbe non essere leggibile nelle finestre registro. Anche se è possibile usarlo, per una maggiore leggibilità ti consigliamo di usare font mono spaziati."
