    ...
    Private Async Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView1.SelectedIndexChanged
        ...
        Try
            If ListView1.SelectedItems.Count = 1 Then
                ...
                Dim downloadReadableSize As String = Converters.BytesToReadableSize(capInfo.DownloadSize, isFrenchSizeText)
                Dim installReadableSize As String = Converters.BytesToReadableSize(capInfo.InstallSize, isFrenchSizeText)
        ...
        Catch ex As Exception
            ...
            Dim msg As String = LocalizationService.ForSection("CapabilityInfo")("Get.Reason.Message")
