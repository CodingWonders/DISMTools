    ...
    Sub GetAppxInformation()
        ...
        Else
            ...
            Try
                ...
                If Environment.OSVersion.Version.Major < 10 Then
                    Contents &= CrLf & "**Information summary for " & MainForm.imgAppxPackageNames.Count - 65536 & " AppX package(s):**" & CrLf & CrLf & FullAppxTableHeader
                ...
                Else
                    ...
                    Using imgSession As DismSession = If(OnlineMode, DismApi.OpenOnlineSession(), DismApi.OpenOfflineSession(ImgMountDir))
                        ...
                        Next
                        Contents &= CrLf & "**Information summary for " & If(MainForm.imgAppxPackageNames.Count - 1 > pkgNames.Count, MainForm.imgAppxPackageNames.Count - 65536, pkgNames.Count) & " AppX package(s):**" & CrLf & CrLf & FullAppxTableHeader
                        Select Case MainForm.Language
                            Case 0
                                Select Case My.Computer.Info.InstalledUICulture.ThreeLetterWindowsLanguageName
                                    Case "ENU", "ENG"
