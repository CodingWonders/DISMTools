...
Public Class PrgAbout
    ...
    Private Sub PrgAbout_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim anniversaryLinkText As String = LocalizationService.ForSection("PrgAbout")("Anniversary.Link")
        LinkLabel6.Text = LocalizationService.ForSection("PrgAbout").Format("Anniversary.Message", anniversaryLinkText)
        Dim anniversaryLinkStart As Integer = LinkLabel6.Text.LastIndexOf(anniversaryLinkText, StringComparison.Ordinal)
        If anniversaryLinkStart >= 0 Then LinkLabel6.LinkArea = New LinkArea(anniversaryLinkStart, anniversaryLinkText.Length)
