            ...
            Case 0
                Select Case My.Computer.Info.InstalledUICulture.ThreeLetterWindowsLanguageName
                    ...
                    Case "PTB", "PTG"
                        ...
                        Label2.Text = "O DISMTools permite-lhe implementar, gerir e efetuar a manutenção de imagens do Windows com facilidade, graças a uma GUI"
                        Label3.Text = "Estes recursos e componentes foram utilizados na criação deste programa:"
                        Label4.Text = "Recursos"
                        Label5.Text = "Fluência"
                        ...
                        Label12.Text = "Assistente de criação de ficheiros de resposta não assistida"
                        ...
                        LinkLabel5.Text = "Visitar o sítio Web"
                        LinkLabel6.Text = "Visitar o sítio Web"
                        LinkLabel7.Text = "Microsoft"
                        ...
                        LinkLabel8.LinkArea = New LinkArea(59, 29)
                        LinkLabel9.Text = "Visitar o sítio Web"
                        LinkLabel10.Text = "Visitar o sítio Web"
                        LinkLabel11.Text = "Microsoft, Kýnan Antos"
                        LinkLabel12.Text = "Visitar o sítio Web"
                        LinkLabel13.Text = "Visitar o sítio Web"
                        OK_Button.Text = "OK"
