...
Public Class ExportDrivers
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        If RadioButton2.Checked AndAlso SelectedClassNamesLB.Items.Count < 1 Then
            MessageBox.Show(LocalizationService.ForSection("ImageOps.Drivers.Export")("Class.Names.Required.Message"), ImageTaskHeader1.ItemText, MessageBoxButtons.OK, MessageBoxIcon.Stop)
            Exit Sub
        End If
