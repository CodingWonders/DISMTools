...
Public Class DriverManualFilePicker
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        If ListView1.Items.Count > 0 Then
            For Each Item As ListViewItem In ListView1.CheckedItems
                ...
                AddDrivers.ListView1.Items.Add(New ListViewItem(New String() {Item.Text, LocalizationService.ForSection("DriverFilePicker.Validation")("File.Label")}))
            Next
        End If
    ...
    Private Sub ScanBW_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles ScanBW.DoWork
        ...
        Label2.Text = LocalizationService.ForSection("Driver.Manual.Scan").Format("Scanning.Driver.Dir.Label", InfFiles.Count)
    ...
    Private Sub ScanBW_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles ScanBW.RunWorkerCompleted
        ...
        Label2.Text = LocalizationService.ForSection("Driver.Manual.Scan").Format("Dir.Complete.Driver.Label", ListView1.Items.Count)
    End Sub
