                ...
                Select Case My.Computer.Info.InstalledUICulture.ThreeLetterWindowsLanguageName
                    Case "ENU", "ENG"
                        ...
                        Label1.Text = "You are about to enter the online installation management mode, which lets you perform changes to your active Windows installation." & CrLf & CrLf & _
                            ...
                            "We AREN'T RESPONSIBLE for any damage done to your active installation. If you are left with an unbootable system, you should re-install Windows (while backing up your files first, if possible)"
                    ...
                    Case "ESN"
                        ...
                        Label1.Text = "Está a punto de entrar en el modo de administración de instalaciones en línea, que le permite realizar cambios a su instalación activa de Windows." & CrLf & CrLf & _
                            ...
                            "Nosotros NO SOMOS RESPONSABLES de cualquier daño producido a su instalación activa. Si se queda con un sistema que no puede iniciar, debería reinstalar Windows (haciendo una copia de seguridad de sus archivos en primer lugar, si es posible)"
                    ...
                    Case "FRA"
                        ...
                        Label1.Text = "Vous êtes sur le point d'entrer dans le mode de gestion de l'installation en ligne, qui vous permet d'apporter des modifications à votre installation Windows active." & CrLf & CrLf & _
                            ...
                            "Nous NE SOMMES PAS RESPONSABLES des dommages causés à votre installation active. Si vous vous retrouvez avec un système non amorçable, vous devez réinstaller Windows (en sauvegardant d'abord vos fichiers, si possible)."
                    ...
                    Case "PTB", "PTG"
                        ...
                        Label1.Text = "Está prestes a entrar no modo de gestão da instalação online, que lhe permite efetuar alterações à sua instalação ativa do Windows." & CrLf & CrLf & _
                            ...
                            "NÃO NOS RESPONSABILIZAMOS por qualquer dano causado à sua instalação ativa. Se ficar com um sistema não arrancável, deve reinstalar o Windows (fazendo primeiro uma cópia de segurança dos seus ficheiros, se possível)"
                    ...
                    Case "ITA"
                        ...
                        Label1.Text = "Si sta per accedere alla modalità di gestione dell'installazione attiva, che consente di apportare modifiche all'installazione attiva di Windows." & CrLf & CrLf & _
                            ...
                            "NON SIAMO RESPONSABILI di eventuali danni arrecati all'installazione attiva. Se il sistema risulta non avviabile, è necessario reinstallare Windows (eseguendo prima un backup dei file, se possibile)"
                        Label2.Text = "Il progetto corrente verrà scaricato"
                        OK_Button.Text = "Continua"
