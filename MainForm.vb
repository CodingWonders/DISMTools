...
Public Class MainForm
    ...
    Public WarnOnMetered As Boolean                         ' Whether to warn when performing network transfers on metered connections
    ...
    Sub LoadDTSettings(LoadMode As Integer, Optional ForceINILoad As Boolean = False)
        ...
        If LoadMode = 0 Then
            ...
            Try
                ...
                WarnOnMetered = CInt(PrgKey.GetValue("WarnOnMetered", 1)) = 1
                PrgKey.Close()
        ...
        ElseIf LoadMode = 1 Then
            ...
            If File.Exists(Path.Combine(Application.StartupPath, "settings.ini")) Then
                ...
                Try
                    ...
                    WarnOnMetered = CInt(GetIniSettingValue(settingData, "Program", "WarnOnMetered", "1")) = 1
    ...
    Sub ShowDTSettings()
        DynaLog.LogMessage("Program Settings:" & CrLf &
                           ...
                           "WarnOnMetered                       =    " & WarnOnMetered & CrLf &
...
#End Region
    ...
    Sub GenerateDTSettings()
        ...
        settingsData("Program").AddKey("WarnOnMetered", 1)
        ...
        PrgKey.SetValue("WarnOnMetered", 1, RegistryValueKind.DWord)
        PrgKey.Close()
    ...
    Sub SaveDTSettings()
        ...
        If SaveOnSettingsIni Then
            ...
            settingsData("Program").AddKey("WarnOnMetered", If(WarnOnMetered, 1, 0))
            settingsData.Sections.AddSection("Personalization")
        ...
        Else
            ...
            Try
                ...
                PrgKey.SetValue("WarnOnMetered", If(WarnOnMetered, 1, 0), RegistryValueKind.DWord)
                PrgKey.Close()
    ...
    Private Sub RefreshNewsFeedLocalizedInformation()
        ...
        Try
            If FeedContents IsNot Nothing AndAlso FeedContents.Items IsNot Nothing AndAlso FeedContents.Items.Any() Then
    ...
    Sub LoadDTProj(DTProjPath As String, DTProjFileName As String, BypassFileDialog As Boolean, SkipBGProcs As Boolean)
        ...
        If RegistryControlPanel.Visible Then
            ...
            If RegistryControlPanel.Visible Then
                ...
                Dim msg As String = LocalizationService.ForSection("Main.Project.Load.Guard")("Image.Registry.Message")
    ...
    Sub UnloadDTProj(IsBeingClosed As Boolean, SaveProject As Boolean)
        ...
        If ImgBW.IsBusy Then
            ...
            Dim msg As String = LocalizationService.ForSection("Main.Project.Unload")("Bg.Procs.Still.Message")
    ...
    Sub BeginOfflineManagement(ImageDrive As String)
        ...
        If RegistryControlPanel.Visible Then
            ...
            If RegistryControlPanel.Visible Then
                DynaLog.LogMessage("Second check determined the image registry control panel is still open. Cannot continue loading project until it's closed")
                Dim msg As String = LocalizationService.ForSection("Main.OfflineManagement")("Image.Registry.Message")
                MsgBox(msg, vbOKOnly + vbExclamation, Text)
                Exit Sub
            End If
        End If
    ...
    Sub EndOfflineManagement()
        If ImgBW.IsBusy Then
            DynaLog.LogMessage("Background processes are busy. Ask the user what they want to do")
            Dim msg As String = LocalizationService.ForSection("Main.EndOfflineMgmt")("Bg.Procs.Still.Message")
            If MsgBox(msg, vbYesNo + vbQuestion, Text) = MsgBoxResult.Yes Then
                DynaLog.LogMessage("Cancelling background processes...")
                ImgBW.CancelAsync()
            Else
    ...
    Sub EndOnlineManagement()
        If ImgBW.IsBusy Then
            DynaLog.LogMessage("Background processes are busy. Ask the user what they want to do")
            Dim msg As String = LocalizationService.ForSection("Main.EndOnlineMgmt")("Bg.Procs.Still.Message")
            If MsgBox(msg, vbYesNo + vbQuestion, Text) = MsgBoxResult.Yes Then
                DynaLog.LogMessage("Cancelling background processes...")
                ImgBW.CancelAsync()
            Else
