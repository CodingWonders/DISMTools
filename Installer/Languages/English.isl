...
UninstallerWord=Uninstaller
AutoReloadTaskDescription=Install automatic image reload service
ServicesTaskGroup=Services
AutoReloadServiceDisplayName=DISMTools Automatic Image Reload Service
AutoReloadServiceDescription=This service automatically reloads the servicing sessions of all mounted images on this computer. Feel free to disable this service if you do not need it.
