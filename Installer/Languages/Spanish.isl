...
AutoReloadTaskDescription=Instalar el servicio de recarga automática de imágenes
ServicesTaskGroup=Servicios
AutoReloadServiceDisplayName=Servicio de recarga automática de imágenes de DISMTools
AutoReloadServiceDescription=Este servicio recarga automáticamente las sesiones de mantenimiento de todas las imágenes montadas en este equipo. Puede deshabilitarlo si no lo necesita.
