...
InstallerWord=programme d’installation
UninstallerWord=programme de désinstallation
AutoReloadTaskDescription=Installer le service de rechargement automatique des images
ServicesTaskGroup=Services
AutoReloadServiceDisplayName=Service de rechargement automatique des images DISMTools
AutoReloadServiceDescription=Ce service recharge automatiquement les sessions de maintenance de toutes les images montées sur cet ordinateur. Vous pouvez le désactiver si vous n’en avez pas besoin.
