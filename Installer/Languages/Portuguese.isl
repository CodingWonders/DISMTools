...
InstallerWord=instalador
UninstallerWord=desinstalador
AutoReloadTaskDescription=Instalar o serviço de recarregamento automático de imagens
ServicesTaskGroup=Serviços
AutoReloadServiceDisplayName=Serviço de recarregamento automático de imagens do DISMTools
AutoReloadServiceDescription=Este serviço recarrega automaticamente as sessões de manutenção de todas as imagens montadas neste computador. Pode desativá-lo se não precisar dele.
