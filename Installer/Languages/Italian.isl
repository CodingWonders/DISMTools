...
InstallerWord=programma di installazione
UninstallerWord=programma di disinstallazione
AutoReloadTaskDescription=Installa il servizio di ricaricamento automatico delle immagini
ServicesTaskGroup=Servizi
AutoReloadServiceDisplayName=Servizio di ricaricamento automatico delle immagini DISMTools
AutoReloadServiceDescription=Questo servizio ricarica automaticamente le sessioni di manutenzione di tutte le immagini montate su questo computer. Puoi disabilitarlo se non ti serve.
