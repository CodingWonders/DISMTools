...
Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Public Sub CatchEmAll(ByVal sender As Object, ByVal e As Microsoft.VisualBasic.ApplicationServices.UnhandledExceptionEventArgs) Handles MyBase.UnhandledException
            MsgBox(LocalizationService.ForSection("DynaViewer.Errors").Format("InternalError.Message", e.Exception.ToString()), vbOKOnly + vbCritical, LocalizationService.ForSection("DynaViewer.Errors")("UnhandledError.Message"))
        End Sub
